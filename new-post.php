                    ...
                    <nav class="site-navigation text-right" role="navigation">
                        ...
                        <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                            ...
                            if (isset ($_GET["prenom"]) && isset($_GET["nom"])) {
                                ...
                                echo "<i class='fas fa-user'></i>  <li class='has-children'>" . $_GET['prenom'] . "  " . $_GET["nom"] . "<ul class='dropdown'><li><a href='startbootstrap-simple-sidebar-gh-pages/index.php'><span class='rounded bg-primary py-2 px-3 text-white'><span class='h5 mr-2'></span> Account</span></a></li><li> <a href='index.php'><span id='sign out' class='rounded bg-danger py-2 px-3 text-white'><span class='h5 mr-2'></span> Sign Out</span></a></li></ul></li>";
                            } else {
...
<?php $nom=$_GET['nom'];
$prenom=$_GET['prenom'];
                    echo "<form method='POST' id='form' class='p-5 bg-white' enctype='multipart/form-data' action='php/job_post.php?nom=$nom&prenom=$prenom' 
                          >"?>
                        <div class="row form-group">
                            <div class="col-md-12 mb-3 mb-md-0">
                                <label class="font-weight-bold" for="fullname"><h3>nom de l'annonce <font
                                        color="red">*</font></h3></label>
                                    <input type="text" name="annonce" id="fullname" class="form-control"
                                           placeholder="votre annonce" required>
                            </div>
                        </div>

                        <div class="row form-group">
                            <div class="col-md-12"><h3 id="catégorie">catégorie<font color="red">*</font></h3></div>
                            <div class="col-md-12 mb-3 mb-md-0">
                                <label for="option-job-type-1">
                                    <input type="checkbox" id="option-job-type-1" value="materiaux"
                                           name="annonce-type[]"> materiaux
                                </label>
                            </div>
                            <div class="col-md-12 mb-3 mb-md-0">
                                <label for="option-job-type-2">
                                    <input type="checkbox" id="option-job-type-2" value="terrain"
                                           name="annonce-type[]"> terrain
                                </label>
                            </div>

                            <div class="col-md-12 mb-3 mb-md-0">
                                <label for="option-job-type-3">
                                    <input type="checkbox" id="option-job-type-3" value="engrais" name="annonce-type[]">
                                    engrais
                                </label>
                            </div>
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 mb-3 mb-md-0">
                                <label class="font-weight-bold" for="prix"><h3>prix <font color="red">*</font></h3>
                                </label>
                                <input type="text" name="prix" id="prix" class="form-control" placeholder="en DT"
                                       required>

                                <label id="prixTxt"></label>
                        ...
                        <div class="row form-group mb-4">
                            <div class="col-md-12"><h3>ville<font color="red">*</font></h3></div>
                            <div class="col-md-12 mb-3 mb-md-0">
                    ...
                    <div class="row form-group mb-4">
                        <div class="col-md-12"><h3>vendre ou louer<font color="red">*</font></h3></div>
                        <div class="col-md-12 mb-3 mb-md-0">
                            <select name="venOUlou" required>
                                <option disabled selected value> --vendre ou louer--</option>
                                <option value="vendre">vendre</option>
                                <option value="alouer">louer</option>
                            </select>
                        </div>
                    </div>
                        <div class="row form-group">
                            <div class="col-md-12 mb-3 mb-md-0">
                                <label class="font-weight-bold" for="image1">
                                    <h3 id="files"> télécharger des photos <font color="red">*</font><h6>(minimum est 1)</h6></h3>
                                </label>
                                <input type="file" name="images[]" id="image1" class="form-control">
                                <input type="hidden" name="images[]" id="image2" class="form-control">
                                <input type="hidden" name="images[]" id="image3" class="form-control">
                                <input type="hidden" name="images[]" id="image4" class="form-control">
                                <input type="hidden" name="images[]" id="image5" class="form-control">
                                <input type="button" value="tester" onclick="testIfImage()">
                            </div>
                            <p id="NO image"></p>
                        </div>
                        <div class="row form-group">
                            <div class="col-md-12"><h3>Description<font color="red">*</font></h3></div>
                            <div class="col-md-12 mb-3 mb-md-0">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                <input type="submit" name="submit" id="submit" value="Post"
                                       class="btn btn-primary  py-2 px-5" disabled>
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="p-4 mb-3 bg-white">
                        ...
                        <p><a href="about.php" class="btn btn-primary  py-2 px-4">Learn More</a></p>
                    </div>
                </div>
            </div>
        </div>
...
<script src="js/test-job-post.js"></script>
